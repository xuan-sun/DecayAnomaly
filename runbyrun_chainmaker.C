#define	path	"Type1_runs_BG_FG_v3"
...
runbyrun_chainmaker()
{
  ...
  mainBGChain->Merge("TimeCalibrated_BGRuns_type1_fixed_v3.root", "RECREATE");
  cout << "Done." << endl;


  TChain *mainFGChain = MergeFileInChain("Foreground_run_numbers_octets_80-120.txt", 1);
  cout << "Merging all chains into one file..." << endl;
  mainFGChain->Merge("TimeCalibrated_FGRuns_type1_fixed_v3.root", "RECREATE");
  cout << "Done." << endl;
